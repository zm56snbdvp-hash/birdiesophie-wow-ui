...
local PROFILE_ID = "deep-clubhouse-3440x1440-v5"
...
local moverPositions = {
  ElvUF_PlayerMover = "BOTTOM,ElvUIParent,BOTTOM,-420,342",
  ElvUF_TargetMover = "BOTTOM,ElvUIParent,BOTTOM,420,342",
  ElvUF_PetMover = "BOTTOM,ElvUIParent,BOTTOM,-420,294",
  ElvUF_FocusMover = "BOTTOM,ElvUIParent,BOTTOM,655,390",
  ElvUF_TargetCastbarMover = "BOTTOM,ElvUIParent,BOTTOM,0,468",
  ElvUF_PlayerCastbarMover = "BOTTOM,ElvUIParent,BOTTOM,-420,286",
  ElvAB_1 = "BOTTOM,ElvUIParent,BOTTOM,0,68",
  ElvAB_2 = "BOTTOM,ElvUIParent,BOTTOM,0,132",
  ElvAB_3 = "BOTTOM,ElvUIParent,BOTTOM,0,188",
  -- Legacy mover names remain harmless fallbacks for older ElvUI builds.
  ElvUI_Bar1_Mover = "BOTTOM,ElvUIParent,BOTTOM,0,68",
  ElvUI_Bar2_Mover = "BOTTOM,ElvUIParent,BOTTOM,0,132",
  ElvUI_Bar3_Mover = "BOTTOM,ElvUIParent,BOTTOM,0,188",
...
local profileSettings = {
  ["general.fontSize"] = 14,
  ["unitframe.fontSize"] = 17,
  ["unitframe.units.player.width"] = 410,
  ["unitframe.units.player.height"] = 108,
  ...
  ["unitframe.units.player.portrait.width"] = 104,
  ["unitframe.units.player.orientation"] = "LEFT",
  ["unitframe.units.player.power.enable"] = true,
  ["unitframe.units.player.power.height"] = 22,
  ["unitframe.units.player.health.text_format"] = "[health:current] / [health:max]  [health:percent]",
  ["unitframe.units.player.power.text_format"] = "[power:current] / [power:max]",
  ["unitframe.units.player.name.text_format"] = "[name:medium]",
  ["unitframe.units.player.buffs.enable"] = true,
  ["unitframe.units.player.buffs.sizeOverride"] = 40,
  ["unitframe.units.player.buffs.perrow"] = 5,
  ["unitframe.units.target.width"] = 410,
  ["unitframe.units.target.height"] = 108,
  ...
  ["unitframe.units.target.portrait.width"] = 104,
  ["unitframe.units.target.orientation"] = "RIGHT",
  ["unitframe.units.target.power.enable"] = true,
  ["unitframe.units.target.power.height"] = 22,
  ["unitframe.units.target.health.text_format"] = "[health:current] / [health:max]  [health:percent]",
  ["unitframe.units.target.power.text_format"] = "[power:current] / [power:max]",
  ["unitframe.units.target.name.text_format"] = "[name:medium]",
  ["unitframe.units.target.debuffs.enable"] = true,
  ["unitframe.units.target.debuffs.sizeOverride"] = 40,
  ["unitframe.units.target.debuffs.perrow"] = 5,
  ["unitframe.units.focus.width"] = 250,
  ["unitframe.units.focus.height"] = 60,
  ["unitframe.units.pet.width"] = 210,
  ["unitframe.units.pet.height"] = 38,
  ["unitframe.colors.health"] = { r = 0.12, g = 0.34, b = 0.20 },
  ["unitframe.colors.health_backdrop"] = { r = 0.025, g = 0.055, b = 0.043 },
  ["unitframe.colors.power.MANA"] = { r = 0.18, g = 0.54, b = 0.62 },
  ["unitframe.colors.power.ENERGY"] = { r = 0.82, g = 0.65, b = 0.25 },
  ["unitframe.colors.power.RAGE"] = { r = 0.66, g = 0.24, b = 0.16 },
  ["general.backdropcolor"] = { r = 0.025, g = 0.055, b = 0.043 },
  ["general.bordercolor"] = { r = 0.78, g = 0.65, b = 0.39 },
  ["general.valuecolor"] = { r = 0.78, g = 0.65, b = 0.39 },
  ["actionbar.fontSize"] = 15,
  ["actionbar.bar1.buttonsize"] = 60,
  ["actionbar.bar1.buttonspacing"] = 8,
  ["actionbar.bar1.buttons"] = 10,
  ["actionbar.bar2.buttonsize"] = 54,
  ["actionbar.bar2.buttonspacing"] = 8,
  ["actionbar.bar2.buttons"] = 10,
  ["actionbar.bar3.buttonsize"] = 48,
  ["actionbar.bar3.buttonspacing"] = 7,
  ["actionbar.bar3.buttons"] = 10,
  ["chat.panelWidth"] = 500,
  ["chat.panelHeight"] = 270,
  ["chat.fontSize"] = 13,
  ["cooldown.override"] = true,
  ["cooldown.fontSize"] = 22,
}
